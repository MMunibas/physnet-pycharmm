...
file_list =[
"CPhOH-avtz-699-1-energy-training.dat",
"CPhOH-avtz-699-1-energy-test.dat",
"CPhOH-avtz-699-1-force-training.dat",
"CPhOH-avtz-699-1-force-test.dat",
"CPhOH-avtz-699-1-energy-training.dat",
"CPhOH-avtz-699-1-energy-test.dat",
"CPhOH-avtz-699-1-force-training.dat",
"CPhOH-avtz-699-1-force-test.dat"]
...
ax3.scatter(x3,delta3, s=5, color='dodgerblue')
ax3.set_xlim([-1690,-1469])
ax3.set_ylim([-4,3])
fig.add_subplot(ax3)
...
ax4.scatter(x4,delta4, s=5, color='dodgerblue')
ax4.set_yticks([])
ax4.set_xlim([-1690,-1469])
ax4.set_ylim([-4,3])
fig.add_subplot(ax4)
#plt.xticks(rotation=45)
...
ax7.scatter(x7,delta7, s=5, color='dodgerblue')
ax7.set_xlim([-800,800])
...
ax8.scatter(x8,delta8, s=5, color='dodgerblue')
ax8.set_yticks([])
ax8.set_xlim([-800,800])
ax8.set_ylim([-100,100])
fig.add_subplot(ax8)
#plt.xticks(rotation=45)
plt.subplots_adjust(bottom=0.12)
fig.text(0.505,0.5,u'\u0394F (kcal/(mol$\cdot$\u00c5))',va='center',ha='center',rotation='vertical',fontdict=font_axis)
fig.text(0.1,0.5,u'\u0394E (kcal/mol)',va='center',ha='center',rotation='vertical',fontdict=font_axis)
...
#save
#plt.savefig("tf-errors-final.png", dpi=100,bbox_inches='tight')
