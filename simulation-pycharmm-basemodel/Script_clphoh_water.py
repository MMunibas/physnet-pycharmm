...
# Write pdb file
write.coor_pdb("init_clphoh.pdb", title="Para Cl-PhOH in water")
...
# Write pdb file
write.coor_pdb("mini_clphoh.pdb", title="Minimized para Cl-PhOH in water")
